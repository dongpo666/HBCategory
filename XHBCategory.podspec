...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/dongpo666/HBCategory"
  ...
  spec.author             = { "东坡" => "xhb@jovision.com" }
  ...
  spec.source       = { :git => "https://github.com/dongpo666/HBCategory.git", :tag => "#{spec.version}" }
